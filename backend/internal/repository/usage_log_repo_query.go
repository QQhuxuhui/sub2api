...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		emptyResponseBillingRuleID sql.NullInt64
	...
	if err := scanner.Scan(
		...
		&accountStatsCost,
		&sessionID,
		&emptyResponseBillingWaived,
		&emptyResponseBillingRuleID,
		&emptyResponseWaivedCost,
		&createdAt,
	); err != nil {
		return nil, err
	}
	...
	log := &service.UsageLog{
		...
		EmptyResponseBillingWaived: emptyResponseBillingWaived,
		EmptyResponseWaivedCost:    emptyResponseWaivedCost,
		CreatedAt:                  createdAt,
	}
	...
	if emptyResponseBillingRuleID.Valid {
		log.EmptyResponseBillingRuleID = emptyResponseBillingRuleID.Int64
	}
