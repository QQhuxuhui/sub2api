...
func UserFromServiceShallow(u *service.User) *User {
	...
	return &User{
		...
		RPMLimit:                   u.RPMLimit,
		RequestTimeoutSeconds:      u.RequestTimeoutSeconds,
...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		NormalizeAnthropicEnvelope:      g.NormalizeAnthropicEnvelope,
		NormalizeResponseModel:          g.NormalizeResponseModel,
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	return &AdminUsageLog{
		...
		EmptyResponseBillingWaived: l.EmptyResponseBillingWaived,
		EmptyResponseBillingRuleID: l.EmptyResponseBillingRuleID,
		EmptyResponseWaivedCost:    l.EmptyResponseWaivedCost,
		IPAddress:                  l.IPAddress,
