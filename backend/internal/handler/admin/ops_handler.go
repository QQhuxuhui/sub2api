...
func NewOpsHandler(opsService *service.OpsService, notifyDispatchers ...*service.OpsNotifyDispatcher) *OpsHandler {
	var notifyDispatcher *service.OpsNotifyDispatcher
	if len(notifyDispatchers) > 0 {
		notifyDispatcher = notifyDispatchers[0]
	}
