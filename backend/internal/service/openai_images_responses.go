...
func (s *OpenAIGatewayService) forwardOpenAIImagesOAuth(
	...
	resp, err := s.doImageUpstreamWithRateLimitRetry(upstreamCtx, buildReq, proxyURL, account, useImpersonate)
...
func (s *OpenAIGatewayService) handleOpenAIImagesOAuthResponseError(
	...
	if upstreamErr.StatusCode == http.StatusTooManyRequests {
		s.recordImageOrgRateLimit(account, headers, responseBody)
	}
