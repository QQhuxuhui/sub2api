...
// IsOpenAIImageChromeImpersonationEnabled reports whether OpenAI image requests
// should use the Chrome TLS/HTTP2 impersonation client. Fail closed by default.
