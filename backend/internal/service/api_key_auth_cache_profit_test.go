...
func TestAPIKeyAuthSnapshotProfitControlRoundtrip(t *testing.T) {
	...
	require.Equal(t, 22, snapshot.Version, "v21：dev 与上游第二次各自推到 19（dev 走 normalize_response_model，上游走 search/audio/video_model_prices），合并后的快照是两者超集，必须再 bump 强制刷新")
