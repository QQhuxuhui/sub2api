...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	intentRouterService := service.NewIntentRouterService(client, redisClient, configConfig)
	intentRouterHandler := admin.NewIntentRouterHandler(intentRouterService)
