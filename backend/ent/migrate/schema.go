...
var (
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "normalize_anthropic_envelope", Type: field.TypeBool, Default: false},
		{Name: "normalize_response_model", Type: field.TypeBool, Default: false},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "empty_response_billing_waived", Type: field.TypeBool, Default: false},
		{Name: "empty_response_billing_rule_id", Type: field.TypeInt64, Nullable: true},
		{Name: "empty_response_waived_cost", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
		{Name: "request_timeout_seconds", Type: field.TypeInt, Default: 0},
	}
