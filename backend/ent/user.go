...
type User struct {
	...
	// RequestTimeoutSeconds holds the value of the "request_timeout_seconds" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldID, user.FieldConcurrency, user.FieldRpmLimit, user.FieldRequestTimeoutSeconds:
