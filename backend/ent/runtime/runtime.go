...
func init() {
	...
	// groupDescNormalizeAnthropicEnvelope is the schema descriptor for normalize_anthropic_envelope field.
	groupDescNormalizeAnthropicEnvelope := groupFields[39].Descriptor()
	// group.DefaultNormalizeAnthropicEnvelope holds the default value on creation for the normalize_anthropic_envelope field.
	group.DefaultNormalizeAnthropicEnvelope = groupDescNormalizeAnthropicEnvelope.Default.(bool)
	// groupDescNormalizeResponseModel is the schema descriptor for normalize_response_model field.
	groupDescNormalizeResponseModel := groupFields[40].Descriptor()
	// group.DefaultNormalizeResponseModel holds the default value on creation for the normalize_response_model field.
	group.DefaultNormalizeResponseModel = groupDescNormalizeResponseModel.Default.(bool)
	...
	// usagelogDescEmptyResponseBillingWaived is the schema descriptor for empty_response_billing_waived field.
	usagelogDescEmptyResponseBillingWaived := usagelogFields[29].Descriptor()
	// usagelog.DefaultEmptyResponseBillingWaived holds the default value on creation for the empty_response_billing_waived field.
	usagelog.DefaultEmptyResponseBillingWaived = usagelogDescEmptyResponseBillingWaived.Default.(bool)
	// usagelogDescEmptyResponseWaivedCost is the schema descriptor for empty_response_waived_cost field.
	usagelogDescEmptyResponseWaivedCost := usagelogFields[31].Descriptor()
	// usagelog.DefaultEmptyResponseWaivedCost holds the default value on creation for the empty_response_waived_cost field.
	usagelog.DefaultEmptyResponseWaivedCost = usagelogDescEmptyResponseWaivedCost.Default.(float64)
