export default {
  ...
  payment: {
    ...
    usdtCalc: {
      title: '我该转多少？',
      intro: '到账金额必须和收银台显示的一分不差。从交易所提币时手续费会从你填的数量里扣掉，所以要多填一点——下面帮你算好。',
      source_exchange: '从交易所提币',
      source_wallet: '用自己的钱包转',
      arrive: '需要到账（{token}）',
      arrivePlaceholder: '收银台显示的金额',
      arriveFromGateway: '已自动读取，网络：{network}。请与收银台显示的金额核对，不一致以收银台为准。',
      arriveWaiting: '在收银台选好网络后会自动填入，也可以手动填写收银台显示的金额。',
      fee: '交易所提币手续费（{token}）',
      feePlaceholder: '在交易所提币页面查看',
      feeHint: '每家交易所、每条网络都不同：TRC20 通常约 1，BSC / Polygon 通常远低于 1。以交易所提币页面显示的为准。',
      resultExchange: '在交易所的「提币数量」里填：',
      resultWallet: '直接转这个数：',
      noteExchange: '{arrive} 到账 + {fee} 手续费。提交前看一眼交易所页面上的「到账数量」，应当正好是 {arrive} {token}。',
      noteWallet: '矿工费由钱包另外用 TRX / BNB 等支付，不会从转账金额里扣。',
      needFee: '填上交易所的提币手续费，就能算出该填多少。',
      copy: '复制',
      copied: '已复制',
    },
    usdtNotice: {
