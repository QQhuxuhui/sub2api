export default {
    ...
    users: {
      ...
      emptyResponseBilling: {
        menuItem: 'Empty-Response Waiver',
        title: 'Empty-Response Billing Waiver',
        subtitle: 'For user {email}: image requests matching a rule are billed $0 when the upstream returns no image at all.',
        columns: {
          group: 'Group',
          model: 'Model',
          enabled: 'Enabled',
        ...
        modelPlaceholder: 'Empty = all models in this group',
        notePlaceholder: 'Optional',
        addRule: 'Add rule',
        remove: 'Remove',
        empty: 'No rules yet. Without rules, empty responses are billed as usual.',
        hint: 'Leave both group and model empty for a user-wide rule. Model names are case-insensitive and match the requested / billing / upstream model. Only applies to pipelines with image-output observation (Gemini native image, OpenAI images).',
        duplicate: 'Duplicate group × model rules exist. Merge them before saving.',
        save: 'Save',
        saving: 'Saving...',
        cancel: 'Cancel',
        updateSuccess: 'Waiver rules updated, effective immediately',
        updateFailed: 'Save failed',
        loadFailed: 'Load failed',
      }
    },
