export default {
  ...
  payment: {
    ...
    usdtCalc: {
      mustArrive: 'The amount that arrives must be exactly',
      waiting: 'Pick a network in the cashier and the amount shows up here',
      rule: 'Even 0.01 short is not credited automatically; use the same network as in the cashier. If it does not arrive, contact support with the transaction hash.',
      fromExchange: 'Withdrawing from an exchange? Work out what to enter',
      fee: 'Exchange fee',
      enter: 'enter as the withdrawal amount',
      feeHint: 'The fee is shown on your exchange withdrawal page. Sending from your own wallet needs no maths: send the amount above.',
      copy: 'Copy',
    },
    usdtNotice: {
      title: 'Before you send USDT',
      exactAmount: 'The amount that arrives must match the cashier exactly — even 0.01 short is not credited automatically.',
      exchangeFee: 'Exchanges deduct a withdrawal fee; the next page works out what to enter for you.',
    },
    methods: {
      easypay: 'EasyPay',
      alipay: 'Alipay',
