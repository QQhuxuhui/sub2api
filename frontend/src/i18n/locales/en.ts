  ...
  admin: {
    ...
    ops: {
      ...
      notifyChannels: {
        ...
        description: 'Push alerts to Feishu bot or any webhook (stored in database).',
        loadFailed: 'Failed to load notify channel config',
        saveSuccess: 'Notify channel config saved',
        saveFailed: 'Failed to save notify channel config',
        noChannels: 'No notify channels configured',
        channelsTitle: 'Channels',
        addChannel: 'Add Channel',
        testSend: 'Send Test',
        testing: 'Sending...',
        testSuccess: 'Test message sent, check the target group/endpoint',
        testFailed: 'Failed to send test message',
        name: 'Name',
        type: 'Type',
        typeFeishu: 'Feishu Bot',
        typeWebhook: 'Generic Webhook',
        webhookUrl: 'Webhook URL',
        secret: 'Signing Secret',
        secretPlaceholder: 'Optional; Feishu sign secret / webhook HMAC secret',
        secretPlaceholderConfigured: 'Configured; leave empty to keep',
        minSeverity: 'Min Severity',
        minSeverityAll: 'All severities',
        rateLimitPerHour: 'Hourly limit (0 = unlimited)',
        notifyResolved: 'Send resolved notifications',
        timeoutSeconds: 'Send timeout (s)',
        criticalErrorTitle: 'Critical Error Instant Notify',
