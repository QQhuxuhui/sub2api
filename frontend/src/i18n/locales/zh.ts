export default {
  ...
  admin: {
    ...
    ops: {
      ...
      notifyChannels: {
        title: '通知通道',
        description: '把告警推送到飞书群机器人或任意 Webhook(存储在数据库中)。',
        loadFailed: '加载通知通道配置失败',
        saveSuccess: '通知通道配置已保存',
        saveFailed: '保存通知通道配置失败',
        noChannels: '暂未配置通知通道',
        channelsTitle: '通道列表',
        addChannel: '添加通道',
        testSend: '发送测试',
        testing: '发送中...',
        testSuccess: '测试消息已发送,请到目标群/端点确认',
        testFailed: '测试消息发送失败',
        name: '名称',
        type: '类型',
        typeFeishu: '飞书机器人',
        ...
        secret: '签名密钥',
        secretPlaceholder: '可选;飞书加签密钥 / Webhook HMAC 密钥',
        secretPlaceholderConfigured: '已配置;留空保持不变',
        minSeverity: '最低级别',
        minSeverityAll: '全部级别',
        rateLimitPerHour: '每小时限额(0 不限)',
        notifyResolved: '发送恢复通知',
        timeoutSeconds: '发送超时(秒)',
        criticalErrorTitle: '严重错误即时通知',
    ...
    settings: {
      ...
      modelMappingTemplate: {
        ...
        jsonHint: "形如 {'{\"gemini-3-pro-preview\": \"gemini-3-pro-high\"}'}，键值均为字符串。",
