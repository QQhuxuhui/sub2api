...
- **Built-in Payment System** - Supports EasyPay, Alipay, WeChat Pay, Stripe, Airwallex and a self-hosted Epusdt (USDT crypto) gateway for user self-service top-up, no separate payment service needed ([Configuration Guide](docs/PAYMENT.md))
