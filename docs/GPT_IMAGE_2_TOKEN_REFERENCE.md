...
| 尺寸 | low | medium | high | med/low | high/med |
|---|---|---|---|---|---|
| 1024×1024 | 196 | **1756** | **7024** | 8.959 | 4.000 |
| 2048×2048 | 397 | **3568** | — | 8.987 | — |
| 3840×2160 | 371 | **3336** | **13342** | 8.992 | 3.999 |

结论：**medium ≈ low × 8.98，high = medium × 4.00（精确），即 high ≈ low × 35.9**，
且倍率与尺寸无关。
